...
(define (get-value-list connectors)
  (map get-value connectors))

(define (set-value-list! connectors ref new-value informant)
  (set-value! (list-ref connectors ref) new-value informant))

(define (adder-list a1s a2s sums)
